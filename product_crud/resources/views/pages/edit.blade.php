                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.update',$product->id) }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input value="{{ old('product_id',$product->product_id) }}" type="text" class="@error('product_id') is-invalid @enderror form-control" placeholder="Product ID" name="product_id">
                                @error('product_id')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea placeholder="Description" class="form-control" name="description"   cols="20" rows="5"> {{ old('description',$product->description) }} </textarea>
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label h5">Price</label>
                                <input value="{{ old('price',$product->price) }}" type="number" class="@error('price') @enderror form-control" placeholder="Price" name="price">
                                @error('price')
                                <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>
